...
while ($tr_t = mysqli_fetch_array($rows)) {
   ...
   if ($tr_t['DayOff']==1)
   {
    ...
    echo "<td><input type='checkbox' checked onchange='ch_r(" . $_POST['id'] . ",".$tr_t['WeekDay'].", 3, Number(this.checked));'></td>";
    ...
    echo "<td><input type='checkbox' onchange='ch_r(" . $_POST['id'] . ",".$tr_t['WeekDay'].", 3, Number(this.checked));'></td>";     
}
